...
filename = '/data3/jmitrevs/HistFitterUser/lepphoton/results/LepPhoton_AllUncertsXsecNominal_SimpleChannel_wino_1500_200_combined_BasicMeasurement_model.root'
regionsList = ['SLEl','SLMu']
signalregionsList = ['SLEl', 'SLMu']

m3 = latexfitresults(filename,regionsList)

f = open('yields_data.tex', 'w')
f.write( tablestart() )
